...
#    trans_box[2] = 0.953
    ...
    Right_inbox = np.array([[-1.2], [-0.25], [0], [1]])
    ...
    Left_inbox = np.array([[-1.2], [0.25], [0], [1]])
...
#    rospy.spin()
    ...
    Right_inbox = np.array([[0], [-0.25], [0], [1]])
    Right_inWorld = (T @ Right_inbox)[0:3]
    Left_inbox = np.array([[0], [0.25], [0], [1]])
    Left_inWorld = (T @ Left_inbox)[0:3]
    ...
    args['target_force_R'] = [0, 0, force]
    args['target_force_L'] = [0, 0, force]
    args['target_position_R'] = [5.18, -0.405-0.135, trans_box[2]+0.15]
    args['target_position_L'] = [5.18, -0.405+0.135, trans_box[2]+0.15]
    ...
    args['target_force_R'] = [0, 0, force]
    args['target_force_L'] = [0, 0, force]
    args['target_position_R'] = [6.18, -0.405-0.135, trans_box[2]+0.15]
    args['target_position_L'] = [6.18, -0.405+0.135, trans_box[2]+0.15]
    ori_R = optas.spatialmath.Quaternion.fromrpy([np.pi+np.pi/2,    np.pi/2 - np.pi/3,    0]).getquat()
    args['target_orientation_R'] = [ori_R[0], ori_R[1], ori_R[2], ori_R[3]]
    ori_L = optas.spatialmath.Quaternion.fromrpy([np.pi-np.pi/2,    np.pi/2 - np.pi/3,    0]).getquat()
    args['target_orientation_L'] = [ori_L[0], ori_L[1], ori_L[2], ori_L[3]]
    ...
    args['target_force_R'] = [0, 0, force]
    args['target_force_L'] = [0, 0, force]
    args['target_position_R'] = [6.18, -0.405-0.135, trans_box[2]-0.04]
    args['target_position_L'] = [6.18, -0.405+0.135, trans_box[2]-0.04]
    # Initialize node class
    args['duration']=5
    cmd_pose_client = CmdPoseClient('client', client,
        args['m_box'],
...
#    )
    ...
    args['target_force_R'] = [0, 0, 0]
    args['target_force_L'] = [0, 0, 0]
    args['target_position_R'] = [6.18, -0.405-0.25, trans_box[2]-0.04]
    args['target_position_L'] = [6.18, -0.405+0.25, trans_box[2]-0.04]
    # Initialize node class
    args['duration']=5
    cmd_pose_client = CmdPoseClient('client', client,
        args['m_box'],
    ...
    args['target_force_R'] = [0, 0, 0]
    args['target_force_L'] = [0, 0, 0]
    args['target_position_R'] = [5, -0.405-0.25, trans_box[2]-0.04]
    args['target_position_L'] = [5, -0.405+0.25, trans_box[2]-0.04]
    # Initialize node class
    args['duration']=3
    cmd_pose_client = CmdPoseClient('client', client,
        args['m_box'],
    ...
    args['target_position_R'] = [0.865, -0.12, 1.0]
    ori_R = optas.spatialmath.Quaternion.fromrpy([np.pi+np.pi/2,    np.pi/2,    0]).getquat()
    args['target_orientation_R'] = [ori_R[0], ori_R[1], ori_R[2], ori_R[3]]
    args['target_position_L'] = [0.865, +0.12, 1.0]
