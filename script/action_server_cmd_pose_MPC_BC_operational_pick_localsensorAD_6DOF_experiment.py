...
#            builder_wholebodyMPC.add_cost_term('Two_arm orientation parallel' + str(i), 0.1*optas.sumsqr(self.ori_fnc_Right(q_var_MPC[:, i]).T @ self.ori_fnc_Left(q_var_MPC[:, i])))
            ...
            builder_wholebodyMPC.add_cost_term('Right_arm Torque world y' + str(i), optas.sumsqr((Tau_ext_Right_var_MPC[:, i] - Tau_ext_Right_goal[:, i]) ))
            builder_wholebodyMPC.add_cost_term('Left_arm Torque world y' + str(i),  optas.sumsqr((Tau_ext_Left_var_MPC[:, i] - Tau_ext_Left_goal[:, i]) ))
...
#        self._ft_left_sub = rospy.Subscriber("/ft_left/raw/data", WrenchStamped, self.read_ft_sensor_left_data_cb)
        ...
        self._head_sub = rospy.Subscriber("/chonk/head_states", Float64MultiArray, self.read_head_states_cb)
