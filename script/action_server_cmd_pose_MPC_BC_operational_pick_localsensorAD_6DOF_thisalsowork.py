    ...
    def timer_cb(self, event):
        ...
        if(self._idx < self._steps):
            ...
            if(self._correct_mux_selection):
                ...
                self._idx += 1
                pos_R_goal = []; ori_R_goal = []; pos_L_goal = []; ori_L_goal = [];
...
#                print('a:')
#                print(np.asarray(self.ori_fnc_Right(self.q_curr)).T[0])
#                print('b:')
#                print(np.asarray(self.ori_fnc_Right(q_next)).T[0])
#                print('a*b')
#                print(self.Derivation_RARM_ori_start)

#                print('al:')
#                print(np.asarray(self.ori_fnc_Left(self.q_curr)).T[0])
#                print('bl:')
#                print(np.asarray(self.ori_fnc_Left(q_next)).T[0])
#                print('al*bl')
#                print(self.Derivation_LARM_ori_start)
...
#        self.acc_box = np.asarray([ msg.data[0], msg.data[1], msg.data[2], 0, msg.data[4], 0])
    ...
    def qaQbConjugate(self, a, b):
        Quaternion_result = optas.casadi.SX(np.zeros(4))
        Quaternion_result[0] = -a[3] * b[0] + a[0] * b[3] - a[1] * b[2] + a[2] * b[1]
        Quaternion_result[1] = -a[3] * b[1] + a[0] * b[2] + a[1] * b[3] - a[2] * b[0]
        Quaternion_result[2] = -a[3] * b[2] - a[0] * b[1] + a[1] * b[0] + a[2] * b[3]
